...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.llama = LlamaModel.from_pretrained("meta-llama/Meta-Llama-3-8B-Instruct")
        self.llama.layers = self.llama.layers[:configs.gpt_layers]
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_out = torch.nn.functional.pad(enc_out, (0, 4096-enc_out.shape[-1]))
